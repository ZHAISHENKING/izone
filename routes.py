...
docs.add_resource(DeleteImg, '/delete/img', endpoint="delete_img")
docs.add_resource(CreateAlbum, '/album', endpoint="create_album")
docs.add_resource(AuthToken, '/user/auth', endpoint="auth")
docs.add_resource(UploadCover, '/user/cover', endpoint="cover")
docs.add_resource(SocketAPI, '/socket', endpoint="socket")